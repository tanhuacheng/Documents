...
if __name__ == '__main__':
    img1 = Image.open(os.path.join(os.path.join(os.path.curdir, 'screen'), 'screen.png'))
    img2 = Image.open(os.path.join(os.path.join(os.path.curdir, 'screen'), 'screen.png'))
    w, h = img1.size
    ...
    for i in range(y-50, y+500 if y+500 < h else h):
        token_l, token_r = 0, 0
